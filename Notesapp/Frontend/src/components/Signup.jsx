...
function NotesApp({ setIslogin }) {
  ...
  const getform = async () => {
    const response = await fetch(
     `https://full-stack-mern-project-2.onrender.com/api/note?date=${date}`,
      {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  const addNote = async (e, id) => {
    ...
    if (edit) {
      ...
      const response = await fetch(
        `https://full-stack-mern-project-2.onrender.com/api/note/${id}`,
        {
          method: "PUT",
          credentials: "include",
          headers: {
      ...
      const response = await fetch(
        "https://full-stack-mern-project-2.onrender.com/api/note",
        {
          method: "POST",
          credentials: "include",
          headers: {
  ...
  const logouthandler = async () => {
    const response = await fetch(
      "https://full-stack-mern-project-2.onrender.com/api/users/islogout",
      {
        method: "GET",
        credentials: "include",
        headers: {
...
>
  ...
  {del
    ...
    : "Add Note"}
            ...
            <form onSubmit={del ? deleteNote : addnote} className="note-form">
              { !del &&
                  <input
                name="title"
                type="text"
